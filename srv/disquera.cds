...
// punto 1
    ...
    action AddMusicians (musicos: array of Musicos) returns Boolean;

    action DeleteMusicians (ids: array of Musicos:ID) returns Boolean;

    function GetMusician(ID: UUID) returns Musicos;
}